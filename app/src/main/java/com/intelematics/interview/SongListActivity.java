...
*/
                ...
                .setNegativeButton("Download", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        try {
                            ...
                            loadDialog.dismiss();
                            loadDialog = ProgressDialog.show(getApplicationContext(), "", "It has occurred the below error: " + JsonParser.getStackTrace(e), true, true);
                        }
                    }
                });
    ...
    public void retrieveSongList() throws CustomException {
        try {
            ...
            throw new CustomException(JsonParser.getStackTrace(ex));
        }
    }
    ...
    public SongListArrayAdapter getListAdapter() {
        return listAdapter;
    }
}
